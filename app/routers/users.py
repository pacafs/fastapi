...
from app.auth.jwt.jwt_handler import create_access_token, decode_token
...
@router.get('/{user_id}', response_model=UserResponse, dependencies=None)
...
def get_current_user_route(current_user: Annotated[User, Depends(get_current_user)]):
